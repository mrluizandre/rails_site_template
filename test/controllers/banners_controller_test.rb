...
class BannersControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create banner" do
    assert_difference('Banner.count') do
      post banners_url, params: { banner: { description: @banner.description, link: @banner.link, location: @banner.location, name: @banner.name, picture: @banner.picture } }
    end
  ...
  test "should update banner" do
    patch banner_url(@banner), params: { banner: { description: @banner.description, link: @banner.link, location: @banner.location, name: @banner.name, picture: @banner.picture } }
